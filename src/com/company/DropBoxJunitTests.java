...
public class DropBoxJunitTests {
    ...
    public void test1() {
        ...
        block.finalize();
        System.out.print(blockHandler.processBlock(block));
    ...
    public void test12() {
        ...
        System.out.print(blockChain.getMaxHeightUTXOPool().getAllUTXO().size() + "\n");
        ...
        System.out.print(blockChain.getMaxHeightUTXOPool().getAllUTXO().size() + "\n");
        //assertTrue("UTXOPool does not contain transaction",blockChain.getMaxHeightUTXOPool());
